...
subroutine surface(xy,aparam,mfit,par1,par2,fparam,surfaceval)
  ...
  real(8) :: xy(2)
  real(8) :: aparam(mfit),fparam(mfit)
  real(8) :: par1,par2     !Only neccessary for coherence in subrout. chisq
...
subroutine surface1(xx,aparam,mfit,dum1,dum2,fparam,surface1val)
  ...
  IMPLICIT REAL(8) (A-H,O-Z)
  real(8) :: xx(2)  !2 dim only neccessary for coherence in subrout. chisq
  real(8) :: aparam(mfit),fparam(mfit)
  real(8) :: dum1,dum2    !Only neccessary for coherence in subrout. chisq
...
! JT OMG this is wasteful, evaluate 55 cases every time.
function term_orig(i,x,y)
