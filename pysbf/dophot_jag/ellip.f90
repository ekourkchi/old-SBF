...
subroutine ellipse(a5,a6,a7,area,amajor,aminor,angle)
  ...
  real(8),parameter :: pi=3.14159, rad2deg=57.29578, sig2fw=2.35482
...
! JT correct the sign error for angle.  It should be angle CCW from x.
...
! 1/2(x2/A+2Bxy+y2/C)=1 <== Ax2+Bxy+Cy2=1 
  a5 = 1.0/(2.0*a)
! JT correct the sign error for tilt.  It should be angle CCW from x.
  a6 = -b
  a7 = 1.0/(2.0*c)
