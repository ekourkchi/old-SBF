...
subroutine findmatch2(starpar,itype,npstar,nsmax,nstot,npap,flags,files,nff,&
  ...
  real(8), parameter :: factor=3.0,siglimup=0.50,siglimdn=0.20
  real(8), parameter :: fbadlim=0.01,sigok=0.10
  integer, parameter :: mbadlim=20

  integer :: itype(nsmax)
  real(8) :: starpar(npstar,nsmax)
  real(8) :: matchpar(npstar),apmatchpar(npap)
  real(8) :: xtempl(nsmax),ytempl(nsmax),magtempl(nsmax)
  real(8) :: xtarg(nsmax),ytarg(nsmax),magtarg(nsmax)
  real(8) :: xpostempl(nsmax),ypostempl(nsmax),mmagtempl(nsmax)
  real(8) :: xpostarg(nsmax),ypostarg(nsmax),mmagtarg(nsmax)
  real(8) :: xhold1(nsmax),yhold1(nsmax)
  real(8) :: xhold2(nsmax),yhold2(nsmax)
  real(8) :: dx(nsmax),dy(nsmax)
  real(8) :: ddx(nsmax),ddy(nsmax)
  real(8) :: diffx(nsmax), diffy(nsmax)
  real(8) :: ax(maxfit),ay(maxfit),axinv(maxfit),ayinv(maxfit)
