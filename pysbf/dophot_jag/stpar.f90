...
function stpar1 (x,y,flags,nff,skyplanepar,npskyp,skyhubpar,npskyh,&
  ...
  real(8) :: skyplanepar(npskyp),skyhubpar(npskyh)
  real(8) :: skymedarray(nfast/iskymedstep,nslow/iskymedstep)
  real(8) :: xy(2),dummyp(npskyp),dummyh(npskyh)
  character(*) :: flags(nff)
...
subroutine stpar567(x,y,flags,nff,enuffvpsf,a5,a6,a7,npsffit,ava,npstar,starpar)
  ...
  real(8) :: ava(npstar)
  real(8) :: a5(npsffit),a6(npsffit),a7(npsffit),dummy(npsffit)
  real(8) :: xy(2)
  character(*) :: flags(nff)
  logical :: enuffvpsf
...
subroutine stparavg(nstot,npstar,nsmax,itype,shadow,shaderr,lverb,nsperf,ava)
  ...
  real(8) :: parwt(npstar),parval(npstar),ava(npstar)
  integer :: itype(nsmax)
...
subroutine stparrms(nstot,nsmax,npstar,starpar,itype,shadow,shaderr,ava,&
  ...
  IMPLICIT REAL(8) (A-H,O-Z)
  real(8) :: stparres(npstar),stparreswt(npstar),starparrms(npstar),roots(npstar)
  real(8) :: starpar(npstar,nsmax),shadow(npstar,nsmax),shaderr(npstar,nsmax)
  real(8) :: a5(npsffit),a6(npsffit),a7(npsffit),ava(npstar),a(npstar)
  integer :: itype(nsmax)
  character(*) :: flags(nff)
