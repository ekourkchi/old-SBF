...
subroutine vpsf (nsperf,nstot,starpar,itype,shadow,shaderr,ava,npstar,nsmax,&
  ...
  real(8) :: starpar(npstar,nsmax),shadow(npstar,nsmax),shaderr(npstar,nsmax)
  integer :: itype(nsmax)
  real(8) ::  xy(2,nsmax)
  real(8) :: sp5(nsmax),sp6(nsmax),sp7(nsmax)
  real(8) :: sperr5(nsmax),sperr6(nsmax),sperr7(nsmax)
  real(8) :: err5(npsffit),err6(npsffit),err7(npsffit)
  real(8) :: accvpsf(npsffit),alimvpsf(npsffit)
...
!        WRITE(77,*) I, NSPERF, XY(1,NSPERF), XY(2,NSPERF), SP5(NSPERF),&
!             SP6(NSPERF), SP7(NSPERF), SPERR5(NSPERF), SPERR6(NSPERF),&
!             SPERR7(NSPERF)
     end if
  end do
